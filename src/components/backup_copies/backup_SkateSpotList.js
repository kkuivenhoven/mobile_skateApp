...
class SkateSpotList extends Component {
  ...
  renderRow(skate_spot){
		console.log("renderRow(skate_spot) -- skate_spot.uid: "  + skate_spot.uid);
		console.log("renderRow() -- Object.keys(skate_spot): "  + Object.keys(skate_spot));
		console.log("renderRow() -- Object.values(skate_spot): "  + Object.values(skate_spot));
...
const mapStateToProps = state => {
	...
	console.log("Object.keys(skate_spots[0]): " + Object.keys(skate_spots[0]));
	console.log("Object.values(skate_spots[0]): " + Object.values(skate_spots[0]));*/
